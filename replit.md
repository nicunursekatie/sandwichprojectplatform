...
- June 30, 2025: Fixed Group Collections Only Mode form error: resolved React Select component issue where empty host names were causing "SelectItem must have non-empty value" error, added filtering to remove empty host names from hostOptions array, Group Collections Only Mode now works correctly without triggering React errors
