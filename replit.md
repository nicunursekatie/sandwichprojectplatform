...
- June 25, 2025: Updated all blue buttons throughout platform to teal color matching brand style guide: changed button backgrounds, hover states, avatar fallbacks, status indicators, and custom CSS classes to maintain consistent brand identity
