...
- June 30, 2025: Cleaned up duplicate Messages navigation: removed standalone Messages item from top-level navigation, consolidated messaging functionality under Team section as single Messages entry pointing to /messages, eliminated navigation duplication and confusion between multiple message-related menu items
