        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="min-w-0 flex-1">
              ...
              <p className="text-teal-100 mt-2 text-lg font-roboto">Share ideas and feedback to improve our operations</p>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200">
          ...
          <div className="p-6">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className={`grid w-full ${canSubmit && hasPermission(currentUser, 'submit_suggestions') ? 'grid-cols-3 sm:grid-cols-5' : 'grid-cols-2 sm:grid-cols-4'} gap-2 bg-gray-100 p-1 rounded-lg`}>
                <TabsTrigger 
                  value="all" 
                ...
                >
                  ...
                  <Badge className="bg-gray-600 text-white text-xs min-w-[20px] justify-center">{tabCounts.all}</Badge>
                </TabsTrigger>
                <TabsTrigger 
                  value="pending" 
                  className="flex items-center gap-2 text-sm font-medium data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-gray-900"
                >
                  ...
                  <Badge className="bg-yellow-600 text-white text-xs min-w-[20px] justify-center">{tabCounts.pending}</Badge>
                </TabsTrigger>
                <TabsTrigger 
                  value="in-progress" 
                  className="flex items-center gap-2 text-sm font-medium data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-gray-900"
                >
                  ...
                  <Badge className="bg-blue-600 text-white text-xs min-w-[20px] justify-center">{tabCounts.inProgress}</Badge>
                </TabsTrigger>
                <TabsTrigger 
                  value="completed" 
                  className="flex items-center gap-2 text-sm font-medium data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-gray-900"
                ...
                {canSubmit && (
                  ...
                  >
                    ...
                    <Badge className="bg-teal-600 text-white text-xs min-w-[20px] justify-center">{tabCounts.mine}</Badge>
                  </TabsTrigger>
                )}
              </TabsList>
                ...
                <div className="bg-white rounded-xl shadow-lg border border-gray-200 mt-6">
                  <div className="border-b border-gray-200 bg-gray-50 rounded-t-xl px-6 py-4">
                    <h2 className="text-lg font-bold text-gray-800 font-roboto flex items-center gap-2">
                      ...
                      <Badge className="bg-gray-600 text-white ml-2">{filteredSuggestions.length}</Badge>
                    </h2>
                  </div>
                  <div className="p-6">
                    {isLoading ? (
                        ...
                        {filteredSuggestions.map((suggestion: Suggestion) => {
                          ...
                          const getStatusBorderColor = (status: string) => {
                            switch (status) {
                              ...
                              case "under_review": return "border-l-purple-500";
                              case "needs_clarification": return "border-l-orange-500";
                          ...
                          return (
                            <div 
                              key={suggestion.id} 
                              className={`border border-gray-200 rounded-lg hover:shadow-md transition-all duration-200 border-l-4 ${getStatusBorderColor(suggestion.status)} group bg-white`}
                            >
                              <div className="p-6">
