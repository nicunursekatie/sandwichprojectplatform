...
const PERMISSION_GROUPS = [
  {
    ...
    permissions: [
      ...
      { key: PERMISSIONS.CREATE_PROJECTS, label: "Create Projects", icon: FolderOpen, description: "Create new projects + edit/delete own projects + edit projects where assigned" },
