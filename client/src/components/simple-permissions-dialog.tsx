...
const PERMISSION_GROUPS = [
  {
    ...
    permissions: [
      ...
      { key: PERMISSIONS.CREATE_COLLECTIONS, label: "Create Collections", icon: Database, description: "Create collections + automatically edit/delete own collections" },
      { key: PERMISSIONS.EDIT_ALL_COLLECTIONS, label: "Edit All Collections", icon: Shield, description: "Edit any collection record (admin level)" },
      { key: PERMISSIONS.DELETE_ALL_COLLECTIONS, label: "Delete All Collections", icon: Shield, description: "Delete any collection record (admin level)" },
      
      { key: PERMISSIONS.ACCESS_PROJECTS, label: "View Projects", icon: Eye, description: "View project information" },
      { key: PERMISSIONS.CREATE_PROJECTS, label: "Create Projects", icon: FolderOpen, description: "Create projects + automatically edit/delete own projects + edit assigned projects" },
      ...
      { key: PERMISSIONS.CREATE_SUGGESTIONS, label: "Create Suggestions", icon: Lightbulb, description: "Create suggestions + automatically edit/delete own suggestions" },
      ...
      { key: PERMISSIONS.CREATE_WORK_LOGS, label: "Create Work Logs", icon: Edit, description: "Create work logs + automatically edit/delete own work logs" },
