        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-8 mt-6 pt-6 border-t border-slate-200">
            <div className="text-center">
              <p className="text-2xl font-bold text-[#922B21] font-roboto">5+</p>
              <p className="text-sm font-medium text-[#666666] uppercase tracking-wider">Years Active</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-[#FBAD3F] font-roboto">25+</p>
              <p className="text-sm font-medium text-[#666666] uppercase tracking-wider">Host Locations</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-[#236383] font-roboto">1.8M+</p>
              <p className="text-sm font-medium text-[#666666] uppercase tracking-wider">Total Impact</p>
            </div>
          </div>
        </div>
      </div>
