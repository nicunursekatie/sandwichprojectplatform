...
--
-- Name: calculate_thread_depth(text); Type: FUNCTION; Schema: public; Owner: neondb_owner
--

CREATE FUNCTION public.calculate_thread_depth(thread_path text) RETURNS integer
...
ALTER FUNCTION public.calculate_thread_depth(thread_path text) OWNER TO neondb_owner;

--
-- Name: generate_thread_path(text, integer); Type: FUNCTION; Schema: public; Owner: neondb_owner
--

CREATE FUNCTION public.generate_thread_path(parent_path text, message_id integer) RETURNS text
    LANGUAGE plpgsql IMMUTABLE
    AS $$
BEGIN
...
ALTER FUNCTION public.generate_thread_path(parent_path text, message_id integer) OWNER TO neondb_owner;

--
-- Name: update_messages_updated_at(); Type: FUNCTION; Schema: public; Owner: neondb_owner
--
...
ALTER FUNCTION public.update_messages_updated_at() OWNER TO neondb_owner;

--
-- Name: validate_read_timestamp(); Type: FUNCTION; Schema: public; Owner: neondb_owner
--

CREATE FUNCTION public.validate_read_timestamp() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.validate_read_timestamp() OWNER TO neondb_owner;
...
CREATE TABLE public.chat_messages (
    id integer NOT NULL,
    channel character varying DEFAULT 'general'::character varying NOT NULL,
...
--
-- Name: committees_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--
...
ALTER SEQUENCE public.committees_id_seq OWNER TO neondb_owner;

--
-- Name: committees_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: kudos_tracking; Type: TABLE; Schema: public; Owner: neondb_owner
--

CREATE TABLE public.kudos_tracking (
    id integer NOT NULL,
    ...
    CONSTRAINT kudos_tracking_context_type_check CHECK ((context_type = ANY (ARRAY['project'::text, 'task'::text])))
);


ALTER TABLE public.kudos_tracking OWNER TO neondb_owner;

--
-- Name: TABLE kudos_tracking; Type: COMMENT; Schema: public; Owner: neondb_owner
--

COMMENT ON TABLE public.kudos_tracking IS 'Prevents kudos spam by tracking sent kudos per context';


--
-- Name: COLUMN kudos_tracking.context_type; Type: COMMENT; Schema: public; Owner: neondb_owner
--

COMMENT ON COLUMN public.kudos_tracking.context_type IS 'Type of entity the kudos relates to (project or task)';


--
-- Name: COLUMN kudos_tracking.context_id; Type: COMMENT; Schema: public; Owner: neondb_owner
--

COMMENT ON COLUMN public.kudos_tracking.context_id IS 'ID of the project or task';


--
-- Name: kudos_tracking_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--

CREATE SEQUENCE public.kudos_tracking_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.kudos_tracking_id_seq OWNER TO neondb_owner;

--
-- Name: kudos_tracking_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE public.kudos_tracking_id_seq OWNED BY public.kudos_tracking.id;
...
--
-- Name: message_reads; Type: TABLE; Schema: public; Owner: neondb_owner
--
...
ALTER TABLE public.message_reads OWNER TO neondb_owner;

--
-- Name: message_reads_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--
...
ALTER SEQUENCE public.message_reads_id_seq OWNER TO neondb_owner;

--
-- Name: message_reads_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: message_recipients; Type: TABLE; Schema: public; Owner: neondb_owner
--
...
ALTER TABLE public.message_recipients OWNER TO neondb_owner;

--
-- Name: TABLE message_recipients; Type: COMMENT; Schema: public; Owner: neondb_owner
--

COMMENT ON TABLE public.message_recipients IS 'Tracks message delivery and read status for each recipient';


--
-- Name: COLUMN message_recipients.context_access_revoked; Type: COMMENT; Schema: public; Owner: neondb_owner
--

COMMENT ON COLUMN public.message_recipients.context_access_revoked IS 'TRUE when recipient loses access to the context (e.g., removed from project)';


--
-- Name: message_recipients_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--
...
ALTER SEQUENCE public.message_recipients_id_seq OWNER TO neondb_owner;

--
-- Name: message_recipients_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: message_threads; Type: TABLE; Schema: public; Owner: neondb_owner
--
...
CREATE TABLE public.message_threads (
    ...
    path text NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT message_threads_depth_check CHECK ((depth >= 0))
);


ALTER TABLE public.message_threads OWNER TO neondb_owner;

--
-- Name: TABLE message_threads; Type: COMMENT; Schema: public; Owner: neondb_owner
--

COMMENT ON TABLE public.message_threads IS 'Maintains message threading hierarchy using materialized paths';


--
-- Name: COLUMN message_threads.path; Type: COMMENT; Schema: public; Owner: neondb_owner
--

COMMENT ON COLUMN public.message_threads.path IS 'Materialized path for efficient thread queries (e.g., 0000000001.0000000005.0000000012)';


--
-- Name: message_threads_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--
...
ALTER SEQUENCE public.message_threads_id_seq OWNER TO neondb_owner;

--
-- Name: message_threads_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--
...
CREATE TABLE public.messages (
    ...
    deleted_by text,
    CONSTRAINT chk_messages_context_type CHECK (((context_type = ANY (ARRAY['suggestion'::text, 'project'::text, 'task'::text, 'direct'::text])) OR (context_type IS NULL))),
    CONSTRAINT chk_messages_edit CHECK ((((edited_at IS NULL) AND (edited_content IS NULL)) OR ((edited_at IS NOT NULL) AND (edited_content IS NOT NULL))))
);
...
COMMENT ON COLUMN public.messages.sender_id IS 'User ID of message sender (replaces user_id)';


--
-- Name: COLUMN messages.context_type; Type: COMMENT; Schema: public; Owner: neondb_owner
--

COMMENT ON COLUMN public.messages.context_type IS 'Links messages to app entities: suggestion, project, task, or direct message';


--
-- Name: COLUMN messages.context_id; Type: COMMENT; Schema: public; Owner: neondb_owner
--

COMMENT ON COLUMN public.messages.context_id IS 'ID of the linked entity (suggestion_id, project_id, etc)';


--
-- Name: COLUMN messages.edited_at; Type: COMMENT; Schema: public; Owner: neondb_owner
--

COMMENT ON COLUMN public.messages.edited_at IS 'Timestamp when message was edited';


--
-- Name: COLUMN messages.edited_content; Type: COMMENT; Schema: public; Owner: neondb_owner
--

COMMENT ON COLUMN public.messages.edited_content IS 'New content after edit (original preserved in content)';


--
-- Name: COLUMN messages.deleted_at; Type: COMMENT; Schema: public; Owner: neondb_owner
--

COMMENT ON COLUMN public.messages.deleted_at IS 'Soft delete timestamp';


--
-- Name: COLUMN messages.deleted_by; Type: COMMENT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: project_congratulations; Type: TABLE; Schema: public; Owner: neondb_owner
--
...
ALTER TABLE public.project_congratulations OWNER TO neondb_owner;

--
-- Name: project_congratulations_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--
...
ALTER SEQUENCE public.project_congratulations_id_seq OWNER TO neondb_owner;

--
-- Name: project_congratulations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: suggestion_responses; Type: TABLE; Schema: public; Owner: neondb_owner
--
...
ALTER TABLE public.suggestion_responses OWNER TO neondb_owner;

--
-- Name: suggestion_responses_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--
...
ALTER SEQUENCE public.suggestion_responses_id_seq OWNER TO neondb_owner;

--
-- Name: suggestion_responses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: suggestions_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--
...
ALTER SEQUENCE public.suggestions_id_seq OWNER TO neondb_owner;

--
-- Name: suggestions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: v_message_threads; Type: VIEW; Schema: public; Owner: neondb_owner
--

CREATE VIEW public.v_message_threads AS
 SELECT mt.id,
    mt.root_message_id,
    mt.message_id,
    mt.depth,
...
ALTER VIEW public.v_message_threads OWNER TO neondb_owner;

--
-- Name: v_unread_counts; Type: VIEW; Schema: public; Owner: neondb_owner
--

CREATE VIEW public.v_unread_counts AS
 SELECT mr.recipient_id,
    m.context_type,
    count(*) AS unread_count,
    (((u.first_name)::text || ' '::text) || (u.last_name)::text) AS sendername,
    u.id AS sender_id
   FROM ((public.message_recipients mr
     JOIN public.messages m ON ((m.id = mr.message_id)))
     JOIN public.users u ON ((m.sender_id = (u.id)::text)))
  WHERE ((mr.read = false) AND (m.deleted_at IS NULL) AND (mr.context_access_revoked = false) AND (u.id IS NOT NULL))
  GROUP BY mr.recipient_id, m.context_type, u.id, u.first_name, u.last_name;


ALTER VIEW public.v_unread_counts OWNER TO neondb_owner;
...
--
-- Name: committees id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: kudos_tracking id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.kudos_tracking ALTER COLUMN id SET DEFAULT nextval('public.kudos_tracking_id_seq'::regclass);
...
--
-- Name: message_reads id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: message_recipients id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: message_threads id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: project_congratulations id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: suggestion_responses id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: suggestions id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--
...
COPY public.chat_messages (id, channel, user_id, user_name, content, created_at) FROM stdin;
1	general	user_1751071509329_mrkw2z95z	Katie	hey	2025-07-17 21:59:30.23
2	core-team	user_1751071509329_mrkw2z95z	Katie	hey	2025-07-17 21:59:35.834
\.
...
104	user_1751071509329_mrkw2z95z	2025-07-11 21:34:36.224383	2025-07-11 21:34:36.224383
104	admin_1751065261945	2025-07-11 21:34:36.305636	2025-07-11 21:34:36.305636
\.
...
--
-- Data for Name: kudos_tracking; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--

COPY public.kudos_tracking (id, sender_id, recipient_id, context_type, context_id, message_id, sent_at) FROM stdin;
1	admin_1751065261945	christine@example.com	task	42	43	2025-07-16 14:02:31.683342
\.
...
--
-- Data for Name: message_reads; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--
...
2	9	user_1751072243271_fc8jaxl6u	f	\N	f	\N	f	2025-06-25 18:41:31.750872
3	11	user_1751072243271_fc8jaxl6u	f	\N	f	\N	f	2025-07-02 22:24:34.005269
...
1	9	user_1751071509329_mrkw2z95z	t	2025-07-12 01:32:46.221	f	\N	f	2025-06-25 18:41:31.750872
12	39	christine@example.com	f	\N	f	\N	f	2025-07-16 14:00:08.092806
13	40	christine@example.com	f	\N	f	\N	f	2025-07-16 14:00:58.325781
14	41	christine@example.com	f	\N	f	\N	f	2025-07-16 14:01:15.481346
15	42	christine@example.com	f	\N	f	\N	f	2025-07-16 14:02:14.00315
16	43	christine@example.com	f	\N	f	\N	f	2025-07-16 14:02:31.607618
17	44	user_1751250351194_sdteqpzz5	t	2025-07-16 16:00:34.617	f	\N	f	2025-07-16 15:59:55.961675
18	45	user_1751072243271_fc8jaxl6u	f	\N	f	2025-07-16 16:30:51.02	f	2025-07-16 16:00:50.604351
19	46	user_1751492211973_0pi1jdl3p	f	\N	f	2025-07-16 16:31:43.852	f	2025-07-16 16:01:43.461331
20	47	user_1751493923615_nbcyq3am7	f	\N	f	2025-07-16 16:31:49.276	f	2025-07-16 16:01:48.980565
21	48	user_1751920534988_2cgbrae86	f	\N	f	2025-07-16 16:32:03.724	f	2025-07-16 16:02:03.430824
22	49	user_1751975120117_tltz2rc1a	f	\N	f	2025-07-16 16:32:21.382	f	2025-07-16 16:02:21.068537
23	50	user_1752522100534_p2nc3wuxg	f	\N	f	2025-07-16 16:33:07.768	f	2025-07-16 16:03:07.445428
...
--
-- Data for Name: message_threads; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--

COPY public.message_threads (id, root_message_id, message_id, depth, path, created_at) FROM stdin;
\.
...
COPY public.messages (id, conversation_id, user_id, content, created_at, sender, updated_at, sender_id, context_type, context_id, edited_at, edited_content, deleted_at, deleted_by) FROM stdin;
19	5	admin_1751065261945	Welcome to Driver Chat! Coordinate deliveries here.	2025-07-08 23:22:37.284028	Admin	2025-07-08 23:22:37.284028	admin_1751065261945	\N	\N	\N	\N	\N	\N
20	6	admin_1751065261945	Welcome to Recipient Chat! Updates and support for receiving organizations.	2025-07-08 23:22:37.284028	Admin	2025-07-08 23:22:37.284028	admin_1751065261945	\N	\N	\N	\N	\N	\N
9	2	user_backup_restored	Reminder meeting	2025-06-25 18:41:31.750872	Admin User	2025-07-08 21:07:51.843861	user_backup_restored	\N	\N	\N	\N	\N	\N
11	2	user_1751071509329_mrkw2z95z	anyone in yet?	2025-07-02 22:24:34.005269	Team Member	2025-07-08 21:07:51.843861	user_1751071509329_mrkw2z95z	\N	\N	\N	\N	\N	\N
26	5	admin_1751065261945	Driver chat is now working! Coordination messages will appear here.	2025-07-09 00:02:53.707994	System Admin	2025-07-09 00:02:53.707994	admin_1751065261945	\N	\N	\N	\N	\N	\N
27	6	admin_1751065261945	Recipient chat is now working! Communication with receiving organizations will appear here.	2025-07-09 00:02:53.707994	System Admin	2025-07-09 00:02:53.707994	admin_1751065261945	\N	\N	\N	\N	\N	\N
30	3	admin_1751065261945	Test message for Marketing Committee	2025-07-09 00:26:25.526112	Admin User	2025-07-09 00:26:25.526112	admin_1751065261945	\N	\N	\N	\N	\N	\N
31	101	user_1751071509329_mrkw2z95z	hi!	2025-07-09 01:41:23.843099	Katie Long	2025-07-09 01:41:23.843099	user_1751071509329_mrkw2z95z	\N	\N	\N	\N	\N	\N
32	102	user_1751071509329_mrkw2z95z	hi!	2025-07-09 01:41:30.317089	Katie Long	2025-07-09 01:41:30.317089	user_1751071509329_mrkw2z95z	\N	\N	\N	\N	\N	\N
33	69	user_1751071509329_mrkw2z95z	hi!	2025-07-09 01:41:34.22351	Katie Long	2025-07-09 01:41:34.22351	user_1751071509329_mrkw2z95z	\N	\N	\N	\N	\N	\N
34	10	user_1751071509329_mrkw2z95z	anyone?	2025-07-09 13:54:45.535903	Katie Long	2025-07-09 13:54:45.535903	user_1751071509329_mrkw2z95z	\N	\N	\N	\N	\N	\N
35	87	admin_1751065261945	📝 Clarification request for your suggestion "Submit your suggestions here!":\n\nDetails?	2025-07-11 21:33:20.239733	Admin User	2025-07-11 21:33:20.239733	admin_1751065261945	\N	\N	\N	\N	\N	\N
36	104	user_1751071509329_mrkw2z95z	📝 Clarification request for your suggestion "Submit your suggestions here!":\n\nDetails?	2025-07-11 21:34:36.37908	Katie Long	2025-07-11 21:34:36.37908	user_1751071509329_mrkw2z95z	\N	\N	\N	\N	\N	\N
43	2	admin_1751065261945	Great job!	2025-07-16 14:02:31.52567	admin@sandwich.project	2025-07-16 21:57:12.26346	admin_1751065261945	task	42	\N	\N	\N	\N
44	2	user_1751071509329_mrkw2z95z	hi	2025-07-16 15:59:55.90075	Katie Long	2025-07-16 21:57:12.26346	user_1751071509329_mrkw2z95z	direct	\N	\N	\N	\N	\N
39	2	admin_1751065261945	Great job!	2025-07-16 14:00:07.996332	admin@sandwich.project	2025-07-16 21:57:12.26346	admin_1751065261945	task	42	\N	\N	\N	\N
40	2	admin_1751065261945	Great job!	2025-07-16 14:00:58.247788	admin@sandwich.project	2025-07-16 21:57:12.26346	admin_1751065261945	task	42	\N	\N	\N	\N
41	2	admin_1751065261945	Great job!	2025-07-16 14:01:15.40636	admin@sandwich.project	2025-07-16 21:57:12.26346	admin_1751065261945	task	42	\N	\N	\N	\N
42	2	admin_1751065261945	Great job!	2025-07-16 14:02:13.929799	admin@sandwich.project	2025-07-16 21:57:12.26346	admin_1751065261945	task	42	\N	\N	\N	\N
45	2	user_1751071509329_mrkw2z95z	hi!	2025-07-16 16:00:50.562636	Katie Long	2025-07-16 21:57:12.26346	user_1751071509329_mrkw2z95z	direct	\N	\N	\N	\N	\N
46	2	user_1751071509329_mrkw2z95z	hi!	2025-07-16 16:01:43.416591	Katie Long	2025-07-16 21:57:12.26346	user_1751071509329_mrkw2z95z	direct	\N	\N	\N	\N	\N
47	2	user_1751071509329_mrkw2z95z	hi!	2025-07-16 16:01:48.940505	Katie Long	2025-07-16 21:57:12.26346	user_1751071509329_mrkw2z95z	direct	\N	\N	\N	\N	\N
48	2	user_1751071509329_mrkw2z95z	Hi! How are you finding the app?!	2025-07-16 16:02:03.392347	Katie Long	2025-07-16 21:57:12.26346	user_1751071509329_mrkw2z95z	direct	\N	\N	\N	\N	\N
49	2	user_1751071509329_mrkw2z95z	Hi! How are you finding the app?! I'd love your feedback on what we can do to make it better!	2025-07-16 16:02:21.022805	Katie Long	2025-07-16 21:57:12.26346	user_1751071509329_mrkw2z95z	direct	\N	\N	\N	\N	\N
50	2	user_1751071509329_mrkw2z95z	Hi! How is the app working for you? If you hit any bugs please send me a message or go to the suggestions tab to report them! Or if you notice something is confusing and feel there might be a better way to organize it!	2025-07-16 16:03:07.402157	Katie Long	2025-07-16 21:57:12.26346	user_1751071509329_mrkw2z95z	direct	\N	\N	\N	\N	\N
51	1	admin_1751065261945	test message from curl	2025-07-17 20:47:08.3381	Katie Long (Admin)	2025-07-17 20:47:08.3381	admin_1751065261945	\N	\N	\N	\N	\N	\N
52	6	admin_1751065261945	Test message for recipient chat	2025-07-17 20:47:30.247217	Katie Long (Admin)	2025-07-17 20:47:30.247217	admin_1751065261945	\N	\N	\N	\N	\N	\N
\.
...
1	test_user	congratulations	Test	Test message	f	project_task	1	\N	2025-07-16 04:29:44.171966
2	test_user	celebration	🏆 Task Completed!	Thanks for completing your task! Great job completing the task!	f	task	1	{"emoji": "🏆", "taskId": 1, "completedAt": "2025-07-16T04:29:49.234Z", "achievementType": "task_completion"}	2025-07-16 04:29:51.452439
3	admin@sandwich.project	celebration	✨ Task Completed!	Thanks for completing your task! Successfully completed task deployment!	f	task	123	{"emoji": "✨", "taskId": 123, "completedAt": "2025-07-16T04:30:35.368Z", "achievementType": "task_completion"}	2025-07-16 04:30:35.562041
4	christine@example.com	congratulations	Great work!	Congratulations on completing your task!	f	\N	\N	\N	2025-07-16 13:39:44.124068
5	christine@example.com	congratulations	Great work!	Congratulations on completing your task!	f	\N	\N	\N	2025-07-16 13:40:44.449437
6	christine@example.com	celebration	💪 Task Completed!	Thanks for completing your task! Task completed successfully!	f	task	42	{"emoji": "💪", "taskId": 42, "completedAt": "2025-07-16T13:40:49.352Z", "achievementType": "task_completion"}	2025-07-16 13:40:49.53598
\.
...
1	25	user_1751071509329_mrkw2z95z	owner	2025-07-14 21:40:51.66
\.
...
--
-- Data for Name: project_congratulations; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--
...
49	ask for final edits	Reach out to Lori one last time and ask for input. Close out circle with Mark.	completed	medium	\N	2025-07-07	2025-07-06 18:01:14.661767	2025-07-11 20:04:07.175	0	18	\N	0	\N	\N	\N	\N	\N	\N
50	close out with Mark	Christine to ask Mark for final edits and close out the catchafire task.	completed	medium	\N	2025-07-11	2025-07-06 18:04:16.454239	2025-07-11 20:04:13.277	0	18	\N	0	\N	\N	\N	\N	\N	\N
\.
...
25	Successfully Updated Project Title	Testing the new multiple user assignment functionality	completed	\N	Marcy Louza, Katie Long, Katie Long	blue	medium	general	2025-07-10	\N	\N	50	\N	\N	\N	\N	2025-07-03 00:55:39.435856	2025-07-17 02:02:41.071	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	["admin_1751065261945", "user_1751071509329_mrkw2z95z"]	Admin User, Katie Long
20	Test Sandwich Project Platform		completed	\N	Katie Long, Marcy Louza, Stephanie Luis, Christine Cooper Nowicki, Vicki Tropauer, Kimberly Ross	blue	high	technology	2025-07-11		\N	0	\N	\N	0	\N	2025-06-30 03:59:14.140364	2025-07-17 02:02:45.887	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	[]	\N
...
26	Catchafire Elevator Speech		in_progress	\N	Marcy Louza	blue	medium	outreach		2025-07-16	\N	0	\N	\N	15	0	2025-07-17 02:04:21.96194	2025-07-17 02:22:41.914	\N	\N	\N	\N	\N	\N	\N	\N	0.00	\N	\N	\N	["user_1751072243271_fc8jaxl6u"]	\N
28	Alloy		in_progress	\N	Christine Cooper Nowicki	blue	high	fundraising	2025-08-31	2025-07-16	\N	0	\N	\N	100	\N	2025-07-17 02:07:47.230273	2025-07-17 19:22:46.28	\N	\N	\N	\N	\N	\N	\N	\N	0.00	\N	\N	\N	["user_1751493923615_nbcyq3am7"]	\N
27	Catchafire - Outreach to Corporations		in_progress	\N	Juliette	blue	medium	operations		2025-07-16	\N	0	\N	\N	12	\N	2025-07-17 02:06:40.546859	2025-07-17 19:23:09.674	\N	\N	\N	\N	\N	\N	\N	\N	0.00	\N	\N	\N	["user_1751072243271_fc8jaxl6u"]	\N
18	Catchafire logo design for Portfolio partnership	Working with a graphic designer to develop a 1" round sticker to go on Portfolio Olive Oil bottles	completed	\N	Christine Cooper Nowicki	blue	medium	fundraising	2025-07-03	2025-06-14	\N	100	\N	\N	0	\N	2025-06-27 21:37:56.528342	2025-07-11 20:04:28.239	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	[]	\N
\.
...
3004	2025-06-26	East Cobb/Roswell	2237	[]	2025-06-27 21:03:52.328332
...
3155	2025-07-09	East Cobb/Roswell	2237	[]	2025-07-17 19:26:39.388207
3156	2025-07-09	Alpharetta	1185	[]	2025-07-17 19:26:55.252573
3157	2025-07-09	Dunwoody/PTC	1240	[]	2025-07-17 19:27:04.823524
3158	2025-07-09	Sandy Springs	350	[]	2025-07-17 19:27:25.528157
3159	2025-07-09	Intown/Druid Hills	528	[]	2025-07-17 19:27:38.009797
3160	2025-07-09	Collective Learning	250	[]	2025-07-17 19:27:47.901462
3161	2025-07-16	Dunwoody/PTC	1297	[]	2025-07-17 19:27:58.359927
3137	2025-06-26	Dunwoody/PTC	2991	[]	2025-07-03 02:29:50.329872
3138	2025-06-26	Intown/Druid Hills	1048	[{"name":"NCL","count":1312}]	2025-07-03 02:30:56.303765
\.
...
poLhQ3W9WujFSw1zqQVgNB70PZ1ppDml	{"user": {"id": "admin_1751065261945", "role": "admin", "email": "admin@sandwich.project", "isActive": true, "lastName": "User", "firstName": "Admin", "permissions": ["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "view_suggestions", "submit_suggestions", "manage_suggestions", "respond_to_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-23T13:58:16.690Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-23 13:59:46
XmVDv1NsdiAzeI4v4H0IELMmRe_B6Gna	{"user": {"id": "user_1751072243271_fc8jaxl6u", "role": "admin", "email": "mdlouza@gmail.com", "isActive": true, "lastName": "Louza", "firstName": "Marcy", "permissions": ["manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "submit_suggestions", "view_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-24T02:01:24.165Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-24 17:27:04
8s7cKBc2PpP1TSInqqYWzIzGwQHWF3er	{"user": {"id": "user_1751071509329_mrkw2z95z", "role": "admin", "email": "katielong2316@gmail.com", "isActive": true, "lastName": "Long", "firstName": "Katie", "permissions": ["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "submit_suggestions", "respond_to_suggestions", "view_suggestions", "manage_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-18T22:03:28.621Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-18 22:20:42
ILd2KzDEZ08Nt_LmtiMMLsagriPs34PK	{"user": {"id": "admin_1751065261945", "role": "admin", "email": "admin@sandwich.project", "isActive": true, "lastName": "User", "firstName": "Admin", "permissions": ["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "view_suggestions", "submit_suggestions", "manage_suggestions", "respond_to_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-23T14:00:00.400Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-23 14:00:59
...
0a-k57N8ukgNmSJM2z-xpXj-pz9n5UWf	{"user": {"id": "admin_1751065261945", "role": "admin", "email": "admin@sandwich.project", "isActive": true, "lastName": "User", "firstName": "Admin", "permissions": ["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "view_suggestions", "submit_suggestions", "manage_suggestions", "respond_to_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-23T14:01:14.230Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-23 14:02:15
...
Oajz2rPs8yE3B0yImaxway2hCFk2ObJs	{"user": {"id": "user_1752522100534_p2nc3wuxg", "role": "volunteer", "email": "Jillbernard.use@gmail.com", "isActive": true, "lastName": "Bernard", "firstName": "Jill", "permissions": ["view_phone_directory", "general_chat", "direct_messages", "group_messages", "toolkit_access", "view_collections", "view_reports", "view_projects", "edit_data", "send_messages", "submit_suggestions"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-21T19:41:51.316Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-22 01:26:59
...
T-7BaaMlSltJoG35pvNtB7uuOwjRRdEw	{"user": {"id": "admin_1751065261945", "role": "admin", "email": "admin@sandwich.project", "isActive": true, "lastName": "User", "firstName": "Admin", "permissions": ["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "view_suggestions", "submit_suggestions", "manage_suggestions", "respond_to_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-23T14:02:30.349Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-23 14:02:32
jSFvEpr08jrTDdBbbWO_ub5Y0d578-RN	{"user": {"id": "user_1751493923615_nbcyq3am7", "role": "admin", "email": "christine@thesandwichproject.org", "isActive": true, "lastName": "Cooper Nowicki", "firstName": "Christine", "permissions": ["view_phone_directory", "edit_data", "delete_data", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "toolkit_access", "view_collections", "view_reports", "view_projects", "view_meetings", "view_analytics", "view_role_demo", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "export_data", "import_data", "direct_messages", "core_team_chat", "group_messages", "manage_hosts", "manage_drivers", "manage_announcements", "manage_projects", "manage_committees", "manage_collections", "manage_recipients", "edit_meetings", "schedule_reports", "send_messages", "moderate_messages", "view_suggestions", "submit_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-18T20:03:05.415Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-20 03:53:53
1ktFR2VprEyeMfxXgkDJnwup3m07MV1S	{"user": {"id": "user_1751071509329_mrkw2z95z", "role": "admin", "email": "katielong2316@gmail.com", "isActive": true, "lastName": "Long", "firstName": "Katie", "permissions": ["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "submit_suggestions", "respond_to_suggestions", "view_suggestions", "manage_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-23T15:40:56.485Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-24 22:02:39
0w-THnuI01I-8tzGPRAaT2RAieIFUTui	{"user": {"id": "user_1751071509329_mrkw2z95z", "role": "admin", "email": "katielong2316@gmail.com", "isActive": true, "lastName": "Long", "firstName": "Katie", "permissions": ["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "submit_suggestions", "respond_to_suggestions", "view_suggestions", "manage_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-24T20:42:36.845Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-24 22:02:25
0pxzh5QlJ34SX6N2uWcbwq97drmnG3L2	{"user": {"id": "user_1751071509329_mrkw2z95z", "role": "admin", "email": "katielong2316@gmail.com", "isActive": true, "lastName": "Long", "firstName": "Katie", "permissions": ["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "submit_suggestions", "respond_to_suggestions", "view_suggestions", "manage_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-23T16:00:42.983Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-24 22:03:01
e0jriXGgrYJ7vkcljKI2EckVSG8b8rJP	{"user": {"id": "admin_1751065261945", "role": "admin", "email": "admin@sandwich.project", "isActive": true, "lastName": "User", "firstName": "Admin", "permissions": ["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "view_suggestions", "submit_suggestions", "manage_suggestions", "respond_to_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-23T16:55:34.473Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-23 16:56:03
IYzcoD14fDgYcZg_oaQt2gOjbCx9pPZj	{"user": {"id": "user_1751071509329_mrkw2z95z", "role": "admin", "email": "katielong2316@gmail.com", "isActive": true, "lastName": "Long", "firstName": "Katie", "permissions": ["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "submit_suggestions", "respond_to_suggestions", "view_suggestions", "manage_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-24T17:59:31.532Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-24 19:33:29
...
nssrez8BtpNJT7L9PqaU4HxE02Lrps5k	{"user": {"id": "admin_1751065261945", "role": "admin", "email": "admin@sandwich.project", "isActive": true, "lastName": "User", "firstName": "Admin", "permissions": ["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "view_suggestions", "submit_suggestions", "manage_suggestions", "respond_to_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-23T17:00:52.719Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-23 17:16:14
mFboDZUcUeRdmDIN89iT5JsE7oaMM5nf	{"user": {"id": "admin_1751065261945", "role": "admin", "email": "admin@sandwich.project", "isActive": true, "lastName": "User", "firstName": "Admin", "permissions": ["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "view_suggestions", "submit_suggestions", "manage_suggestions", "respond_to_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-23T16:56:17.875Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-23 16:56:54
...
xfJdEz5GWbDJ1ftHNm-e849S7PNfa4lk	{"user": {"id": "admin_1751065261945", "role": "admin", "email": "admin@sandwich.project", "isActive": true, "lastName": "Long (Admin)", "firstName": "Katie", "permissions": ["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "view_suggestions", "submit_suggestions", "manage_suggestions", "respond_to_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-24T20:47:07.283Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-24 20:49:24
gmNfZFgjiwUz8gub_3wVdLUN6PoCUpoo	{"user": {"id": "admin_1751065261945", "role": "admin", "email": "admin@sandwich.project", "isActive": true, "lastName": "User", "firstName": "Admin", "permissions": ["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "view_suggestions", "submit_suggestions", "manage_suggestions", "respond_to_suggestions", "view_sandwich_data"], "profileImageUrl": null}, "cookie": {"path": "/", "secure": false, "expires": "2025-07-18T21:37:13.619Z", "httpOnly": true, "sameSite": "lax", "originalMaxAge": 604800000}}	2025-07-18 21:37:14
...
--
-- Data for Name: suggestion_responses; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--
...
--
-- Data for Name: suggestions; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--
...
3	Submit your suggestions here!	If you need something to work differently, if something is confusing to you, you have tips on how we could better arrange this whole site, or if you run into a bug, please submit your feedback here so we can get this where it serves your needs the best it possibly can!	General	High	under_review	admin_1751065261945	admin@sandwich.project	Admin User	f	0	{}	\N	\N	user_1751071509329_mrkw2z95z	\N	2025-07-11 17:51:26.043519	2025-07-11 20:50:58.365
\.
...
user_1751250351194_sdteqpzz5	kenig.ka@gmail.com	Katie	Long	\N	2025-06-30 02:25:51.374	2025-07-16 16:00:29.156	driver	["view_phone_directory", "general_chat", "driver_chat", "direct_messages", "group_messages", "toolkit_access", "view_collections", "view_reports", "view_projects", "send_messages"]	t	{"password": "sandwich123"}	Katie (Alternate)	\N	2025-07-16 16:00:29.155
...
user_1751072243271_fc8jaxl6u	mdlouza@gmail.com	Marcy	Louza	\N	2025-06-28 00:57:23.476	2025-07-17 02:01:24.052	admin	["manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "submit_suggestions", "view_suggestions", "view_sandwich_data"]	t	{"password": "sandwich123"}	Marcy	\N	2025-07-17 02:01:24.051
user_1751493923615_nbcyq3am7	christine@thesandwichproject.org	Christine	Cooper Nowicki	\N	2025-07-02 22:05:23.700884	2025-07-11 20:03:05.288	admin	["view_phone_directory", "edit_data", "delete_data", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "toolkit_access", "view_collections", "view_reports", "view_projects", "view_meetings", "view_analytics", "view_role_demo", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "export_data", "import_data", "direct_messages", "core_team_chat", "group_messages", "manage_hosts", "manage_drivers", "manage_announcements", "manage_projects", "manage_committees", "manage_collections", "manage_recipients", "edit_meetings", "schedule_reports", "send_messages", "moderate_messages", "view_suggestions", "submit_suggestions", "view_sandwich_data"]	t	{"password": "sandwich123"}	\N	\N	2025-07-11 20:03:05.287
user_1751492211973_0pi1jdl3p	stephanie@thesandwichproject.org	Stephanie	Luis	\N	2025-07-02 21:36:52.064276	2025-07-11 19:47:36.118	admin	["view_phone_directory", "edit_data", "delete_data", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "toolkit_access", "view_collections", "view_reports", "view_projects", "view_meetings", "view_analytics", "view_role_demo", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "export_data", "import_data", "direct_messages", "core_team_chat", "group_messages", "manage_hosts", "manage_drivers", "manage_announcements", "manage_projects", "manage_committees", "manage_collections", "manage_recipients", "edit_meetings", "schedule_reports", "send_messages", "view_suggestions", "submit_suggestions", "view_sandwich_data"]	t	{"password": "ChloeMarie24!"}	\N	\N	2025-07-08 18:07:29.481
user_1751071509329_mrkw2z95z	katielong2316@gmail.com	Katie	Long	\N	2025-06-28 00:45:09.513	2025-07-17 20:42:36.624	admin	["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "submit_suggestions", "respond_to_suggestions", "view_suggestions", "manage_suggestions", "view_sandwich_data"]	t	{"password": "sandwich123"}	Katie Long	\N	2025-07-17 20:42:36.624
user_1752522100534_p2nc3wuxg	Jillbernard.use@gmail.com	Jill	Bernard	\N	2025-07-14 19:41:40.649292	2025-07-14 19:41:51.191	volunteer	["view_phone_directory", "general_chat", "direct_messages", "group_messages", "toolkit_access", "view_collections", "view_reports", "view_projects", "edit_data", "send_messages", "submit_suggestions"]	t	{"password": "4305Jill"}	\N	\N	2025-07-14 19:41:51.191
admin_1751065261945	admin@sandwich.project	Katie	Long (Admin)	\N	2025-06-27 23:01:01.987	2025-07-17 20:47:07.058	admin	["manage_users", "manage_hosts", "manage_recipients", "manage_drivers", "manage_collections", "manage_announcements", "manage_committees", "manage_projects", "view_phone_directory", "view_hosts", "view_recipients", "view_drivers", "view_committee", "view_users", "view_collections", "view_reports", "view_meetings", "view_analytics", "view_projects", "view_role_demo", "edit_data", "edit_meetings", "delete_data", "schedule_reports", "general_chat", "committee_chat", "host_chat", "driver_chat", "recipient_chat", "core_team_chat", "direct_messages", "group_messages", "send_messages", "export_data", "import_data", "toolkit_access", "moderate_messages", "view_suggestions", "submit_suggestions", "manage_suggestions", "respond_to_suggestions", "view_sandwich_data"]	t	{"password": "sandwich123"}	Katie (admin)	\N	2025-07-17 20:47:07.058
\.
...
--
-- Data for Name: work_logs; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--
...
--
-- Name: agenda_items_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: committee_memberships_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: committees_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
SELECT pg_catalog.setval('public.conversations_id_seq', 105, true);


--
-- Name: drive_links_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: driver_agreements_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: host_contacts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: hosted_files_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: hosts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: kudos_tracking_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--

SELECT pg_catalog.setval('public.kudos_tracking_id_seq', 1, true);


--
-- Name: meeting_minutes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: message_reads_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
SELECT pg_catalog.setval('public.message_recipients_id_seq', 23, true);


--
-- Name: message_threads_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
SELECT pg_catalog.setval('public.messages_id_seq', 52, true);
...
--
-- Name: project_comments_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: project_congratulations_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: project_documents_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: project_tasks_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: recipients_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: sandwich_collections_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--

SELECT pg_catalog.setval('public.sandwich_collections_id_seq', 3161, true);


--
-- Name: suggestion_responses_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: suggestions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: task_completions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--

SELECT pg_catalog.setval('public.task_completions_id_seq', 17, true);
...
--
-- Name: work_logs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--
...
--
-- Name: agenda_items agenda_items_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: committee_memberships committee_memberships_committee_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: committee_memberships committee_memberships_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: committees committees_name_key; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: committees committees_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: drive_links drive_links_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: driver_agreements driver_agreements_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: host_contacts host_contacts_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: hosted_files hosted_files_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: kudos_tracking kudos_tracking_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.kudos_tracking
    ADD CONSTRAINT kudos_tracking_pkey PRIMARY KEY (id);


--
-- Name: meeting_minutes meeting_minutes_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: message_reads message_reads_message_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: message_reads message_reads_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: message_recipients message_recipients_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: message_threads message_threads_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: project_comments project_comments_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: project_congratulations project_congratulations_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: project_documents project_documents_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: sandwich_collections sandwich_collections_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: suggestion_responses suggestion_responses_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: task_completions task_completions_task_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: kudos_tracking uq_kudos_unique; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.kudos_tracking
    ADD CONSTRAINT uq_kudos_unique UNIQUE (sender_id, recipient_id, context_type, context_id);


--
-- Name: message_recipients uq_message_recipient; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: message_threads uq_message_thread; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.message_threads
    ADD CONSTRAINT uq_message_thread UNIQUE (message_id);
...
--
-- Name: idx_conversation_participants_user_id; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: idx_kudos_context; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_kudos_context ON public.kudos_tracking USING btree (context_type, context_id);


--
-- Name: idx_kudos_recipient; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_kudos_recipient ON public.kudos_tracking USING btree (recipient_id);


--
-- Name: idx_kudos_sender; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_kudos_sender ON public.kudos_tracking USING btree (sender_id);


--
-- Name: idx_message_reads_message; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: idx_message_reads_user; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: idx_message_recipients_email_pending; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_message_recipients_email_pending ON public.message_recipients USING btree (recipient_id, read, email_sent_at) WHERE ((read = false) AND (email_sent_at IS NULL));


--
-- Name: idx_message_recipients_message; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: idx_message_recipients_recipient; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: idx_message_recipients_unread; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_message_recipients_unread ON public.message_recipients USING btree (recipient_id, read) WHERE (read = false);


--
-- Name: idx_message_recipients_unread_counts; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_message_recipients_unread_counts ON public.message_recipients USING btree (recipient_id, read, message_id) WHERE (read = false);


--
-- Name: idx_messages_context; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_messages_context ON public.messages USING btree (context_type, context_id) WHERE (context_type IS NOT NULL);


--
-- Name: idx_messages_context_lookup; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_messages_context_lookup ON public.messages USING btree (context_id) WHERE (context_type IS NOT NULL);
...
--
-- Name: idx_messages_deleted; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_messages_deleted ON public.messages USING btree (deleted_at) WHERE (deleted_at IS NULL);
...
--
-- Name: idx_thread_depth; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_thread_depth ON public.message_threads USING btree (depth);


--
-- Name: idx_thread_path; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_thread_path ON public.message_threads USING btree (path text_pattern_ops);


--
-- Name: idx_thread_root; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_thread_root ON public.message_threads USING btree (root_message_id);


--
-- Name: idx_thread_traversal; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_thread_traversal ON public.message_threads USING btree (root_message_id, path, depth);


--
-- Name: idx_work_logs_status; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: idx_work_logs_user_id; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: messages trigger_messages_updated_at; Type: TRIGGER; Schema: public; Owner: neondb_owner
--
...
--
-- Name: message_recipients trigger_validate_read; Type: TRIGGER; Schema: public; Owner: neondb_owner
--

CREATE TRIGGER trigger_validate_read BEFORE INSERT OR UPDATE ON public.message_recipients FOR EACH ROW EXECUTE FUNCTION public.validate_read_timestamp();


--
-- Name: committee_memberships committee_memberships_committee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: conversation_participants conversation_participants_conversation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: kudos_tracking kudos_tracking_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.kudos_tracking
    ADD CONSTRAINT kudos_tracking_message_id_fkey FOREIGN KEY (message_id) REFERENCES public.messages(id) ON DELETE CASCADE;


--
-- Name: message_reads message_reads_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: message_recipients message_recipients_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: message_threads message_threads_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.message_threads
    ADD CONSTRAINT message_threads_message_id_fkey FOREIGN KEY (message_id) REFERENCES public.messages(id) ON DELETE CASCADE;


--
-- Name: message_threads message_threads_root_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.message_threads
    ADD CONSTRAINT message_threads_root_message_id_fkey FOREIGN KEY (root_message_id) REFERENCES public.messages(id) ON DELETE CASCADE;
...
--
-- Name: project_comments project_comments_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: project_congratulations project_congratulations_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: work_logs work_logs_approved_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: work_logs work_logs_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--
